 ...
 */
final class Version20210318082729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE membre_activite (membre_id INTEGER NOT NULL, activite_id INTEGER NOT NULL, PRIMARY KEY(membre_id, activite_id))');
        $this->addSql('CREATE INDEX IDX_D17BD266A99F74A ON membre_activite (membre_id)');
        $this->addSql('CREATE INDEX IDX_D17BD269B0F88B1 ON membre_activite (activite_id)');
        ...
        $this->addSql('DROP INDEX IDX_3713CEFD9B0F88B1');
        $this->addSql('DROP INDEX IDX_3713CEFDFD02F13');
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement_activite AS SELECT evenement_id, activite_id FROM evenement_activite');
        $this->addSql('DROP TABLE evenement_activite');
        $this->addSql('CREATE TABLE evenement_activite (evenement_id INTEGER NOT NULL, activite_id INTEGER NOT NULL, PRIMARY KEY(evenement_id, activite_id), CONSTRAINT FK_3713CEFDFD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3713CEFD9B0F88B1 FOREIGN KEY (activite_id) REFERENCES activite (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO evenement_activite (evenement_id, activite_id) SELECT evenement_id, activite_id FROM __temp__evenement_activite');
        $this->addSql('DROP TABLE __temp__evenement_activite');
        ...
        $this->addSql('DROP INDEX IDX_FB6065376A99F74A');
        $this->addSql('DROP INDEX IDX_FB606537FD02F13');
        $this->addSql('CREATE TEMPORARY TABLE __temp__participer_event AS SELECT id, evenement_id, membre_id FROM participer_event');
        $this->addSql('DROP TABLE participer_event');
        $this->addSql('CREATE TABLE participer_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, evenement_id INTEGER DEFAULT NULL, membre_id INTEGER DEFAULT NULL, CONSTRAINT FK_FB606537FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_FB6065376A99F74A FOREIGN KEY (membre_id) REFERENCES membre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO participer_event (id, evenement_id, membre_id) SELECT id, evenement_id, membre_id FROM __temp__participer_event');
        $this->addSql('DROP TABLE __temp__participer_event');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement_activite AS SELECT evenement_id, activite_id FROM evenement_activite');
        $this->addSql('DROP TABLE evenement_activite');
        $this->addSql('CREATE TABLE evenement_activite (evenement_id INTEGER NOT NULL, activite_id INTEGER NOT NULL, PRIMARY KEY(evenement_id, activite_id))');
        $this->addSql('INSERT INTO evenement_activite (evenement_id, activite_id) SELECT evenement_id, activite_id FROM __temp__evenement_activite');
        $this->addSql('DROP TABLE __temp__evenement_activite');
        $this->addSql('CREATE INDEX IDX_3713CEFDFD02F13 ON evenement_activite (evenement_id)');
        $this->addSql('CREATE INDEX IDX_3713CEFD9B0F88B1 ON evenement_activite (activite_id)');
