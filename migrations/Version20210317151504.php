 ...
 */
final class Version20210317151504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, adresse, date_deb, date_fin, visibilite, nb_pers, message FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, membre_id INTEGER DEFAULT NULL, adresse VARCHAR(255) NOT NULL COLLATE BINARY, date_deb DATETIME NOT NULL, date_fin DATETIME NOT NULL, visibilite INTEGER NOT NULL, nb_pers INTEGER NOT NULL, message CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_B26681E6A99F74A FOREIGN KEY (membre_id) REFERENCES membre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO evenement (id, adresse, date_deb, date_fin, visibilite, nb_pers, message) SELECT id, adresse, date_deb, date_fin, visibilite, nb_pers, message FROM __temp__evenement');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, adresse, date_deb, date_fin, visibilite, nb_pers, message FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, adresse VARCHAR(255) NOT NULL, date_deb DATETIME NOT NULL, date_fin DATETIME NOT NULL, visibilite INTEGER NOT NULL, nb_pers INTEGER NOT NULL, message CLOB NOT NULL)');
        $this->addSql('INSERT INTO evenement (id, adresse, date_deb, date_fin, visibilite, nb_pers, message) SELECT id, adresse, date_deb, date_fin, visibilite, nb_pers, message FROM __temp__evenement');
        $this->addSql('DROP TABLE __temp__evenement');
        $this->addSql('DROP INDEX IDX_F30253EFD02F13');
        $this->addSql('DROP INDEX IDX_F30253E6A99F74A');
