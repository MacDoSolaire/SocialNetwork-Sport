 ...
 */
class getMessagePriveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessagePriveRepository' shared autowired service.
     *
     * @return \App\Repository\MessagePriveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessagePriveRepository.php';

        return $container->privates['App\\Repository\\MessagePriveRepository'] = new \App\Repository\MessagePriveRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
