 ...
 */
class getAmitieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AmitieRepository' shared autowired service.
     *
     * @return \App\Repository\AmitieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AmitieRepository.php';

        return $container->privates['App\\Repository\\AmitieRepository'] = new \App\Repository\AmitieRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
